...
<%
        ...
        <div style="text-align:right;margin-right:3%;margin-bottom:1%;"> 
          <a href="men.jsp?gendercategory=男性&&orderBy=highToLow">價格高至低</a><i class="fa-solid fa-up-long" style="color:white"></i>
          <a href="men.jsp?gendercategory=男性&&orderBy=lowTohigh">價格低至高</a><i class="fa-solid fa-down-long" style="color:white"></i>
        </div>
